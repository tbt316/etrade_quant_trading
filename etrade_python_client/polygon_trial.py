...
client = RESTClient(api_key="_18MWTD835FLBXG2p6JHpHfrHeoKqN6T") # api_key is used
...
contractData = contractNames[1]
print(contractData)

contractData2 = contractNames[100]
print(contractData2)

#get options ticker
optionsTicker = contractData.ticker
print(contractData.ticker)
