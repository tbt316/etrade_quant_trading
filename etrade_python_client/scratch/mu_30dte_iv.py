"""
Constant-Maturity 30-DTE ATM IV for Micron (MU) — 5 Year History
=================================================================
Methodology:
...
async def main():
    ...
    # For each expiration, pre-fetch a band of strikes.
    # We'll use the spot price at the START of the window where this exp
    # would be the "nearest 30-DTE" as the ATM reference.
    # Simpler: fetch a fixed set of absolute strikes per expiry, let IV calc
    # pick the closest ATM one at each date during post-processing.
